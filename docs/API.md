...
| `Surface.decode_png` | Bounded non-interlaced PNG decoding at supported 1/2/4/8/16-bit color combinations; native filtering, full-width transparency and RGBA8 normalization in [PNG.md](PNG.md). |
