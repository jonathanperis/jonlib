...
positions while Bend has no native signed integer type. Fractional coordinates,
NaN/infinity and larger values are outside the current compatibility profile.
