...
- Core `raylib.h`: **600 functions**, **101 partial**, **0 complete**.
...
| 7 | 1 | `pixels` — Colors and pixel formats | 46 | 19 | 0 | numerics, memory |
...
- **`raylib:function:LoadImageRaw`** (not-started, `image-codecs`): Derive LoadImageRaw semantics from the linked source, add a reference fixture, then implement Surface.load_image_raw.
