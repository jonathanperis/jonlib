...
- Core `raylib.h`: **600 functions**, **103 partial**, **0 complete**.
...
| 5 | 1 | `files` — Files, paths, compression and data utilities | 49 | 1 | 0 | memory |
...
| 10 | 1 | `image-codecs` — Image codecs and export | 8 | 4 | 0 | files, pixels, images |
