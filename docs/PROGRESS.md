...
- Core `raylib.h`: **600 functions**, **84 partial**, **0 complete**.
...
| 6 | 1 | `random` — Random-number and sequence contracts | 4 | 2 | 0 | numerics, memory |
| 7 | 1 | `pixels` — Colors and pixel formats | 46 | 15 | 0 | numerics, memory |
| 8 | 1 | `images` — Image creation, primitives and transformations | 54 | 44 | 0 | pixels, memory |
...
- **`raylib:function:GenImageCellular`** (not-started, `images`): Derive GenImageCellular semantics from the linked source, add a reference fixture, then implement Surface.gen_image_cellular.
