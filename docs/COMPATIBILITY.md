...
| PNG decoding | `Surface.decode_png` | Non-interlaced 1/2/4/8/16-bit profiles; byte filtering, palette/tRNS, full-width transparency before narrowing, split IDAT and bounded errors |
