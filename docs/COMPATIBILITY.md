...
| PNG decoding | `Surface.decode_png` | Non-interlaced 8-bit color types 0/2/3/4/6 and 1/2/4-bit grayscale/palette; packed filters, palette/tRNS, split IDAT and bounded error controls |
