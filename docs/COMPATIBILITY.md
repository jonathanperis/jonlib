...
The current local Apple M1/macOS corpus contains **217 deterministic scenarios /
33,959 checked output words per lane**, matching native CPU (one and two threads), JavaScript
and forced Metal. Most words are RGBA pixels; 1,515 are exact numeric/collision
...
these scoped operations/contracts. The companion ledger additionally maps 130
